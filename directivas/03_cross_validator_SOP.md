...
- **Meta de Precisión:** Minimizar alucinaciones y falsos positivos para alcanzar un nivel de precisión de respuesta del **93.3%** mediante prompts altamente contextualizados en el framework Groq utilizando el modelo configurado en `GROQ_MODEL` (default `openai/gpt-oss-120b`; ver `directivas/09_lead_scoring_engine_SOP.md`).
